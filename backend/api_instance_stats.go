...
func (r ApiInstanceStatsTotalCategoriesRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
	return r.ApiService.InstanceStatsTotalCategoriesExecute(r)
}
...
InstanceStatsTotalCategories Get the number of total categories.
 ...
 @return ApiInstanceStatsTotalCategoriesRequest
*/
func (a *InstanceStatsApiService) InstanceStatsTotalCategories(ctx _context.Context) ApiInstanceStatsTotalCategoriesRequest {
	return ApiInstanceStatsTotalCategoriesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *InstanceStatsApiService) InstanceStatsTotalCategoriesExecute(r ApiInstanceStatsTotalCategoriesRequest) (map[string]interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InstanceStatsApiService.InstanceStatsTotalCategories")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stats/totalcategories"
...
func (r ApiInstanceStatsTotalProductsRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
	return r.ApiService.InstanceStatsTotalProductsExecute(r)
}
...
InstanceStatsTotalProducts Get the number of total products.
 ...
 @return ApiInstanceStatsTotalProductsRequest
*/
func (a *InstanceStatsApiService) InstanceStatsTotalProducts(ctx _context.Context) ApiInstanceStatsTotalProductsRequest {
	return ApiInstanceStatsTotalProductsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *InstanceStatsApiService) InstanceStatsTotalProductsExecute(r ApiInstanceStatsTotalProductsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InstanceStatsApiService.InstanceStatsTotalProducts")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stats/totalproducts"
